...
countries = ['КИТАЙ', 'РОССИЯ', 'КАЗАХСТАН', 'ГРЕЦИЯ', 'ИЗРАИЛЬ', 'ИСПАНИЯ', 'ВЕЛИКОБРИТАНИЯ', 'ТУРЦИЯ', 'ПОЛЬША',
             'КАНАДА']  # 10 стран в словаре
cities = ['ПЕКИН', 'МОСКВА', 'АСТАНА', 'АФИНЫ', 'ИЕРУСАЛИМ', 'МАДРИД', 'ЛОНДОН', 'АНКАРА', 'ВАРШАВА',
          'ОТТАВА']  # 10 столиц в словаре
